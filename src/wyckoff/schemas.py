...
class EventsModel(BaseModel):
    ...
    vsa_menhongtao: Optional[Dict[str, Any]] = Field(default=None, description="孟氏 VSA 完整检测结果")
    dead_corner_breakout: Optional[Dict[str, Any]] = Field(default=None, description="死角突破检测结果")
