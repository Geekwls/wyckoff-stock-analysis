...
"""
    ...
    def generate_json(self) -> str:
        ...
        # 增加Wyckoff三大定律完整分析
        wyckoff_laws = {
            "supply_demand_law": self.analyze_supply_demand_law(),
            "effort_vs_result_law": self.analyze_effort_vs_result_law(),
            "cause_effect_law": self.analyze_cause_effect_law_enhanced()
        }
